...
namespace ClubManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250808213411_FixUserMemberRelationship")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClubManagement.Shared.Models.Event", b =>
                {
                    ...
                    b.Property<string>("AllowedMembershipTiers")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<bool>("RequiresFacilityAccess")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("RequiresFacilityAccess")
                    ...
                    b.HasIndex("FacilityId", "StartDateTime", "EndDateTime")
            ...
            modelBuilder.Entity("ClubManagement.Shared.Models.Facility", b =>
                {
                    ...
                    b.Property<int>("MemberConcurrentBookingLimit")
                        .HasColumnType("integer");

                    b.Property<decimal>("MemberHourlyRate")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal>("NonMemberHourlyRate")
                        .HasColumnType("numeric");
                    ...
                    b.Property<bool>("RequiresMemberSupervision")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("FacilityTypeId", "Status");
            ...
            modelBuilder.Entity("ClubManagement.Shared.Models.FacilityBooking", b =>
                {
                    ...
                    b.Property<bool>("RequiresStaffSupervision")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ClubManagement.Shared.Models.MemberBookingLimit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("AllowRecurringBookings")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("CancellationPenaltyHours")
                        .HasColumnType("integer");
                    ...
                    b.Property<TimeSpan?>("EarliestBookingTime")
                        .HasColumnType("interval");
                    ...
                    b.Property<TimeSpan?>("LatestBookingTime")
                        .HasColumnType("interval");
                    ...
                    b.HasIndex("ApplicableTier", "IsActive");

                    b.HasIndex("FacilityId", "IsActive");

                    b.HasIndex("FacilityTypeId", "IsActive");

                    b.HasIndex("MemberId", "IsActive");

                    b.HasIndex("EffectiveFrom", "EffectiveTo", "IsActive");

                    b.ToTable("MemberBookingLimits");
                });

            modelBuilder.Entity("ClubManagement.Shared.Models.MemberFacilityCertification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MemberId", "CertificationType", "IsActive");

                    b.ToTable("MemberFacilityCertifications");
                });
            ...
            modelBuilder.Entity("ClubManagement.Shared.Models.MemberFacilityCertification", b =>
                {
                    b.HasOne("ClubManagement.Shared.Models.User", "CertifiedByUser")
                        .WithMany()
